...
public class Main {
    ...
    private static void exercise1() {
        ...
        String ChangedNumbertoString = String.valueOf(ourNumberInt);
        System.out.println("The current value is: " + ChangedNumbertoString);
    }
    ...
    private static void exercise3() {
        ...
        String doubleStrToConvert = "10.5"; // Also this line
    ...
    private static void exercise4() {
        ...
        String startStr = "5 ";
        // Write your code here
        startStr = startStr.replaceAll("\\s", "");
        int StringInt = Integer.valueOf(startStr);
        System.out.println("Int value of the start string: " + StringInt);
        StringInt = StringInt * 2;
        startStr = String.valueOf(StringInt);
        startStr = startStr + startStr;
        System.out.println("The current value is: " + startStr);
        double StringDouble = Double.valueOf(startStr);
        StringDouble = StringDouble / 3.5;
        Math.floor(StringDouble);
        System.out.println("The current value is: " + Math.floor(StringDouble));
    }
}
